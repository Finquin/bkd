  ...
  async save(obj) {
    ...
    try {
      ...
      if (dataArchParse.length) {
        ...
        await fs.writeFile(this.ruta, JSON.stringify([...dataArchParse, { ...obj, id: dataArchParse[dataArchParse.length - 1].id + 1 }], null, 2));
        /* devolvemos al id del objeto creado  */
        console.log(`el numero de id es ${dataArchParse.length + 1}`);
      } else {
        ...
        /* devolvemos al id del objeto creado  */
        console.log("el numero de id es 1");
      }
    } catch (err) {
  ...
  async getAll() {
    ...
    try {
      ...
      if (dataArchParse.length) {
        ...
        console.log("Los productos son", dataArchParse);
      } else {
